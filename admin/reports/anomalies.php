...
$anomaly_count = $conn->query("SELECT COUNT(*) AS total FROM exams WHERE status = 'rejected'")->fetch_assoc()['total'];
$conn->close();
?>
<!DOCTYPE html>
<html lang="en">
...
<div class="dashboard">
    ...
    <div class="main-content">
        <div class="page-header">
            <h2>Anomalies Report</h2>
        </div>
        <div class="card card-accent-blue">
            <p>Total rejected exams: <?= htmlspecialchars($anomaly_count); ?></p>
        </div>
    </div>
</div>
